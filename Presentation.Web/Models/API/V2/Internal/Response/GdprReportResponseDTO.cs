...
namespace Presentation.Web.Models.API.V2.Internal.Response
{
    public class GdprReportResponseDTO
    {
        ...
        public required IEnumerable<string> SensitiveDataTypes { get; set; }
        ...
        public required string TechnicalSupervisionDocumentationUrlName { get; set; }
        ...
        public required IEnumerable<string> InsecureCountriesSubjectToDataTransfer { get; set; }
    }
}