...
namespace Presentation.Web.Models.API.V2.Response.Options
{
    public class RoleOptionExtendedResponseDTO : RoleOptionResponseDTO, IOptionAvailability
    {
        ...
        public RoleOptionExtendedResponseDTO(Guid uuid, string name, bool writeAccess, bool isAvailable, string description, bool isExternallyUsed, string externallyUsedDescription)
            : base(uuid, name, writeAccess, description, isExternallyUsed, externallyUsedDescription)
        {
