...
{
    public class CurrentAspNetCoreRequest : ICurrentHttpRequest
    {
        private readonly ILogger _logger;
        private readonly ICurrentRequestStream _currentRequestStream;

        public CurrentAspNetCoreRequest(ILogger logger, ICurrentRequestStream currentRequestStream)
        {
            _logger = logger;
        ...
        public ISet<string> GetDefinedJsonProperties(IEnumerable<string> pathTokens)
        {
            ...
            {
                _logger.ForContext<CurrentAspNetCoreRequest>().Error(e, "Failed while inspecting root properties");
