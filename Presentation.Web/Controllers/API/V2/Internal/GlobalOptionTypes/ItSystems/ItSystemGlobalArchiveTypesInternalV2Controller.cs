...
namespace Presentation.Web.Controllers.API.V2.Internal.GlobalOptionTypes.ItSystems
{
    ...
    public class ItSystemGlobalArchiveTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItSystemUsage, ArchiveType>
    {
        ...
        [HttpPost]
        [Route("")]
        public IActionResult CreateGlobalArchiveType([FromBody] GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [HttpPatch]
        [Route("{optionUuid}")]
        public IActionResult PatchGlobalArchiveType([NonEmptyGuid][FromRoute] Guid optionUuid,
