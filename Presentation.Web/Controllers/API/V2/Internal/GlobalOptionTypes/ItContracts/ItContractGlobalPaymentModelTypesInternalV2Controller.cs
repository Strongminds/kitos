...
namespace Presentation.Web.Controllers.API.V2.Internal.GlobalOptionTypes.ItContracts
{
    ...
    public class ItContractGlobalPaymentModelTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItContract, PaymentModelType>
    {
        ...
        [HttpPost]
        [Route("")]
        public IActionResult CreateGlobalPaymentModelType(GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [HttpPatch]
        [Route("{optionUuid}")]
        public IActionResult PatchGlobalPaymentModelType([NonEmptyGuid][FromQuery] Guid optionUuid,
