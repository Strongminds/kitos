...
namespace Presentation.Web.Controllers.API.V2.Internal.GlobalOptionTypes.ItContracts
{
    ...
    public class ItContractGlobalAgreementElementTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItContract, AgreementElementType>
    {
        ...
        [HttpPost]
        [Route("")]
        public IActionResult CreateGlobalAgreementElementType([FromBody] GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [HttpPatch]
        [Route("{optionUuid}")]
        public IActionResult PatchGlobalAgreementElementType([NonEmptyGuid][FromRoute] Guid optionUuid,
