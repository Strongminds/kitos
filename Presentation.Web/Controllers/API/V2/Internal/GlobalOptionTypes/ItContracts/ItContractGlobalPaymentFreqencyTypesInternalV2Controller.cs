...
{
    [Route("api/v2/internal/it-contract/global-option-types/payment-frequency-types")]
    ...
    public class ItContractGlobalPaymentFrequencyTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItContract, PaymentFreqencyType>
    {
        ...
        [HttpGet]
        [Route("")]
        public IActionResult GetGlobalPaymentFreqencyTypes()
        {
            return GetAll();
        }
        ...
        [HttpPatch]
        [Route("{optionUuid}")]
        public IActionResult PatchGlobalPaymentFreqencyType([NonEmptyGuid][FromRoute] Guid optionUuid,
