...
namespace Presentation.Web.Controllers.API.V2.Internal.GlobalOptionTypes.ItContracts
{
    ...
    public class ItContractGlobalPriceRegulationTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItContract, PriceRegulationType>
    {
        ...
        [HttpPost]
        [Route("")]
        public IActionResult CreateGlobalPriceRegulationType(GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [HttpPatch]
        [Route("{optionUuid}")]
        public IActionResult PatchGlobalPriceRegulationType([NonEmptyGuid][FromQuery] Guid optionUuid,
