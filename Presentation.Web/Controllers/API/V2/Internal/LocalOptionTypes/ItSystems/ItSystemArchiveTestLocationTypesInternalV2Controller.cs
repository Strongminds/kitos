...
namespace Presentation.Web.Controllers.API.V2.Internal.LocalOptionTypes.ItSystems
{
    ...
    public class ItSystemLocalArchiveTestLocationTypesInternalV2Controller : BaseLocalRegularOptionTypesInternalV2Controller<LocalArchiveTestLocation, ItSystemUsage, ArchiveTestLocation>
    {
        ...
        [HttpGet]
        [Route("")]
        public IActionResult GetLocalArchiveTestLocationTypes([NonEmptyGuid][FromQuery] Guid organizationUuid)
        {
        ...
        [HttpGet]
        [Route("{optionUuid}")]
        public IActionResult GetLocalArchiveTestLocationTypeByOptionId([NonEmptyGuid][FromQuery] Guid organizationUuid, [FromQuery] Guid optionUuid)
        {
        ...
        [HttpPost]
        [Route("")]
        public IActionResult CreateLocalArchiveTestLocationType([NonEmptyGuid][FromQuery] Guid organizationUuid, [FromBody] LocalOptionCreateRequestDTO dto)
        {
        ...
        [HttpPatch]
        [Route("{optionUuid}")]
        public IActionResult PatchLocalArchiveTestLocationType([NonEmptyGuid][FromQuery] Guid organizationUuid,
        ...
        [HttpDelete]
        [Route("{optionUuid}")]
        public IActionResult DeleteLocalArchiveTestLocationType([NonEmptyGuid][FromQuery] Guid organizationUuid,
            [FromQuery] Guid optionUuid)
        {
