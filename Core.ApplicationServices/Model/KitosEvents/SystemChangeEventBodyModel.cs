...
public class SystemChangeEventBodyModel : IEventBody
{
    ...
    public Dictionary<string, object?> ToKeyValuePairs()
    {
        ...
        if (DataProcessorUuid.HasChange) keyValuePairs.Add(nameof(DataProcessorUuid), DataProcessorUuid.NewValue?.HasValue == true ? DataProcessorUuid.NewValue.Value : null);
