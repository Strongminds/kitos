...
{
    public class BaseGenericLocalOptionsService<TLocalOptionType, TReferenceType, TOptionType>
        ...
        where TOptionType : OptionEntity<TReferenceType>
    {
        ...
        public BaseGenericLocalOptionsService(IGenericRepository<TOptionType> optionsRepository,
        ...
        public IEnumerable<TOptionType> BaseGetLocalOptions(Guid organizationUuid, Action<TOptionType, TLocalOptionType> updateLocalOptionValues)
        {
            ...
            return IncludeLocalChangesToGlobalOptions(globalOptions, localOptions, updateLocalOptionValues)
                     .OrderByDescending(x => x.Priority);
        }

        private static IEnumerable<TOptionType> IncludeLocalChangesToGlobalOptions(IEnumerable<TOptionType> globalOptions, IDictionary<int, TLocalOptionType> localOptions, Action<TOptionType, TLocalOptionType> updateLocalOptionValues)
        {
        ...
        public Result<TOptionType, OperationError> BaseGetLocalOption(Guid organizationUuid, Guid globalOptionUuid, Action<TOptionType, TLocalOptionType> updateLocalOptionValues)
        {
        ...
        public Result<TOptionType, OperationError> BaseCreateLocalOption(Guid organizationUuid, LocalOptionCreateParameters parameters, Action<TOptionType, TLocalOptionType> updateLocalOptionValues)
        {
                ...
                .Bind(organizationId =>
                {
                    return GetLocalOptionMaybe(organizationUuid, parameters.OptionUuid)
                        .Match(existingLocalOption =>
                        {
                            ...
                            return BaseGetLocalOption(organizationUuid, parameters.OptionUuid, updateLocalOptionValues);
                        }, () =>
                        {
                            ...
                            return BaseGetLocalOption(organizationUuid, globalOptionUuid, updateLocalOptionValues);
                        });
                });
        }
                ...
                .Match(localOption => ValidateModify(localOption)
                    .Bind(
                        localOptionWithModifyRights =>
                        {
                            ...
                            if (updateExtraParameters != null)
                            {
                                var updateParametersError = updateExtraParameters(localOptionWithModifyRights, parameters);
                                if (updateParametersError.HasValue)
                                    return updateParametersError.Value;
                            }
                    ...
                    ResolveOrganizationIdAndValidateCreate(organizationUuid)
                        .Bind(orgId =>
                        {
                            ...
                            if (updateExtraParameters != null)
                            {
                                var updateParametersError = updateExtraParameters(newLocalOption, parameters);
                                if (updateParametersError.HasValue)
                                    return updateParametersError.Value;
                            }
        ...
        public Result<TOptionType, OperationError> BaseDeleteLocalOption(Guid organizationUuid, Guid globalOptionUuid, Action<TOptionType, TLocalOptionType> updateLocalOptionValues)
        {
            return GetLocalOptionMaybe(organizationUuid, globalOptionUuid)
                .Match(Result<TLocalOptionType, OperationError>.Success,
                    () => CreateAndGetLocalOption(organizationUuid, globalOptionUuid, updateLocalOptionValues))
                .Bind(localOption =>
                {
        ...
        private Result<TLocalOptionType, OperationError> CreateAndGetLocalOption(Guid organizationUuid, Guid globalOptionUuid, Action<TOptionType, TLocalOptionType> updateLocalOptionValues)
        {
            return BaseCreateLocalOption(organizationUuid,
                new LocalOptionCreateParameters() { OptionUuid = globalOptionUuid }, updateLocalOptionValues)
                .Bind(_ =>
                {
