...
namespace Infrastructure.DataAccess.Mapping
{
    public class ItSystemUsageOverviewReadModelMap : IEntityTypeConfiguration<ItSystemUsageOverviewReadModel>
    {
        public void Configure(EntityTypeBuilder<ItSystemUsageOverviewReadModel> builder)
        {
            ...
            builder.HasIndex(x => x.GdprCriticalityId).HasDatabaseName("ItSystemUsageOverviewReadModel_Index_GdprCriticalityId");
            builder.HasIndex(x => x.GdprCriticalityUuid).HasDatabaseName("ItSystemUsageOverviewReadModel_Index_GdprCriticalityUuid");
            builder.Property(x => x.GdprCriticalityName).HasMaxLength(Organization.MaxNameLength);
            builder.HasIndex(x => x.GdprCriticalityName).HasDatabaseName("ItSystemUsageOverviewReadModel_Index_GdprCriticalityName");
