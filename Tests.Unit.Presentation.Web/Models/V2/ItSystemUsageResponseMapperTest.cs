...
namespace Tests.Unit.Presentation.Web.Models.V2
{
    public class ItSystemUsageResponseMapperTest : WithAutoFixture
    {
        ...
        public void MapSystemUsageDTO_Maps_General_Properties_Section()
        {
            ...
            AssertYesNoExtended(dto.General.CriticalityInfo.IsSociallyCritical, itSystemUsage.CriticalityInfo.IsSociallyCritical);
            AssertYesNoExtended(dto.General.CriticalityInfo.BusinessCritical, itSystemUsage.CriticalityInfo.isBusinessCritical);
        }
        ...
        private void AssignGeneralPropertiesSection(ItSystemUsage itSystemUsage)
        {
            ...
            itSystemUsage.CriticalitySection.isBusinessCritical = A<DataOptions>();
